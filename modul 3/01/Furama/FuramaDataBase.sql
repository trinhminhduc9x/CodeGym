...
VALUES ('1', 'Quản Lý'),
 ...
 INSERT INTO `Furama`.`bo_phan` (`ma_bo_phan`, `ten_bo_phan`) VALUES
 ('1', 'Sale-Marketing'),
 ('2', 'Hành chính'),
 ('3', 'Phục vụ'),
 ('4', 'Quản lý');
 ...
 INSERT INTO `Furama`.`trinh_do` (`ma_trinh_do`, `ten_trinh_do`) VALUES
 ('1', 'Trung Cấp'),
 ('2', 'Cao Đẳng'),
 ('3', 'Đại Học'),
 ('4', 'Sau Đại Học');
...
INSERT INTO `Furama`.`loai_dich_vu` (`ma_loai_dich_vu`, `ten_loai_dich_vu`) VALUES
 ('1', 'Villa'),
 ('2', 'House'),
 ('3', 'Room');
...
INSERT INTO `Furama`.`hop_dong` (`ma_hop_dong`, `ngay_lam_hop_dong`, `ngay_ket_thuc`, `tien_dat_coc`, `ma_nhan_vien`, `ma_khach_hang`, `ma_dich_vu`) VALUES
...
INSERT INTO `Furama`.`hop_dong_chi_tiet` (`ma_hop_dong_chi_tiet`, `so_luong`, `ma_hop_dong`, `ma_dich_vu_di_kem`) 
VALUES
 ('1', '5', '2', '4'),
 ('2', '8', '2', '5'),
 ('3', '15', '2', '6'),
