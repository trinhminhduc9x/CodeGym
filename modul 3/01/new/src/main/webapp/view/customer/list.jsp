        ...
        <form action="/Customer?action=searchCustomer" method="post">
            ...
            <div class="row mt-2">
                <select name="customerTypeId" id="" class="form-control">
                    ...
                    <c:forEach var="FacilityType" items="${customerTypeList}">
                        <option value="${FacilityType.customerTypeId}">${FacilityType.customerTypeName}</option>
                    </c:forEach>
                </select>
            </div>
        ...
        <table id="tableStudent" class="border table table-striped table-hover table-bordered" border="1">
            ...
            <c:forEach items="${customerList}" var="customer" varStatus="status">
                <tr>
                    ...
                    <td>${customer.id}</td>
                    <td>
                        <c:forEach items="${customerTypeList}" var="FacilityType">
                            <c:if test="${customer.customerTypeId==FacilityType.customerTypeId}">
                                ${FacilityType.customerTypeName}
                            </c:if>
                        </c:forEach>
                    </td>
                    <td>${customer.name}</td>
