...
////      Kiểm tra ngày sinh
//        LocalDate birthday;
//        if (!customer.founding().isEmpty()) {
//            try {
//                founding = LocalDate.parse(customer.founding());
//                if (Period.between(birthday, LocalDate.now()).getYears() < 18) {
//                    errorMap.put("founding", "Chưa đủ 18 tuổi");
//                }
//            } catch (Exception e) {
//                errorMap.put("founding", "Nhập sai format(định dạng ngày là:yyyy-MM-dd");
//            }
//        } else {
