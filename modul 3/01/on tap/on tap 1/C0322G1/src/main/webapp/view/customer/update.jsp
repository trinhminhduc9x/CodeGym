    ...
    <form class="w-50 text-warning fw-bold shadow-lg p-5 bg-light" action="/Customer?action=updateCustomer" method="post">
        ...
        <div class="row">
            <div class="col-md-6">
                <div class="mb-3">
                    ...
                    <select class="border-warning border-3 rounded-3 form-select-md" name="customerType"
                        ...
                        <c:forEach items="${customerTypeList}" var="customerType">
                            <c:if test="${customer.idMember!=customerType.idMember}">
                                <option value="${customerType.idMember}">${customerType.idMember}</option>
                            </c:if>
                        </c:forEach>
                    </select>
                </div>
                ...
                <div class="mb-3">
                    <label for="founding" class="form-label">foundingy</label>
                    <input type="date" class="form-control" name="founding" value="${customer.founding}"
                           id="founding">
