...
public class CustomerServlet extends HttpServlet {
    ...
    private void updateCustomer(HttpServletRequest request, HttpServletResponse response) throws IOException, ServletException {
        int id = Integer.parseInt(request.getParameter("id"));
        int idMember = Integer.parseInt(request.getParameter("customerTypeId"));
        String name = request.getParameter("name");
        String founding =request.getParameter("dateOfBirth");
        int number =Integer.parseInt( request.getParameter("id_card"));
