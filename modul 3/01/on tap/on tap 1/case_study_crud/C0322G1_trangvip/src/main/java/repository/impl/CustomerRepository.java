...
public class CustomerRepository implements ICustomerRepository {
    ...
    private static final String DELETE_CUSTOMER = " delete from `household`.`house_hold` where id_House_Hold =? ";
    private static final String INSERT_INTO_CUSTOMER = " insert into `household`.`house_hold`(`id_House_Hold`, `id_member`, `name_House_Hold`, `number_House_Hold`, `founding`, `Address`) VALUES (?, ?, ?, ?,?,?) ";
    ...
    public Customer selectCustomer(int id) {
        ...
        try {
            ...
            ResultSet resultSet = preparedStatement.executeQuery();
            while (resultSet.next()) {
                int customerId = resultSet.getInt("id_House_Hold");// điền đúng tên các cột từ đa ta base//
                int customerTypeId = resultSet.getInt("id_member");
                String name = resultSet.getString("name_House_Hold");
                int number = resultSet.getInt("number_House_Hold");
                String founding = resultSet.getString("founding");
                String address = resultSet.getString("Address");
                customer = new Customer(customerId,customerTypeId,name,number,founding,address);
            }
        } catch (SQLException e) {
            e.printStackTrace();
        }
