...
public class CustomerTypeRepository implements ICustomerTypeRepository {
    private final String  FIND_ALL_CUSTOMER_TYPE="select * from HinhThucThanhToan;";
    ...
    public List<CustomerType> FindAll() {
        ...
        try {
            ...
            while (resultSet.next()){
                int id= resultSet.getInt("STTHinhThucThanhToan");
                String name = resultSet.getString("TenHinhThucThanhToan");
