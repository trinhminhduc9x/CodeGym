...
create procedure insert_user (
     ...
     call insert_user('Bon','duc1@gmail.com','Viet Nam');
...
Delimiter $$
create procedure updateUser(id_sp int, name_sp varchar(45), email_sp varchar(45), country_sp varchar(45))
begin
	update users 
    set name = name_sp,
				email= email_sp,
